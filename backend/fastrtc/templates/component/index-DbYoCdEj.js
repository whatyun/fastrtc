...
function A2(n) {
  ...
  return {
    ...
    l(l) {
      ...
      var s = wa(e);
      t = ya(s, "path", { d: !0 }), wa(t).forEach(jn), r = ya(s, "path", { d: !0 }), wa(r).forEach(jn), a = ya(s, "line", { x1: !0, y1: !0, x2: !0, y2: !0 }), wa(a).forEach(jn), i = ya(s, "line", { x1: !0, y1: !0, x2: !0, y2: !0 }), wa(i).forEach(jn), s.forEach(jn), this.h();
    },
    h() {
...
function e5(n) {
  ...
  return {
    ...
    l(s) {
      ...
      t = xa(o, "title", {});
      var u = Sa(t);
      r = Z2(u, "High volume"), u.forEach(Wn), a = xa(o, "path", { d: !0, "stroke-width": !0 }), Sa(a).forEach(Wn), i = xa(o, "path", {
        d: !0,
        "stroke-width": !0,
        "stroke-linecap": !0,
        "stroke-linejoin": !0
      }), Sa(i).forEach(Wn), l = xa(o, "path", {
        d: !0,
        "stroke-width": !0,
        "stroke-linecap": !0,
        "stroke-linejoin": !0
      }), Sa(l).forEach(Wn), o.forEach(Wn), this.h();
    },
    h() {
...
function s5(n) {
  ...
  return {
    c() {
      e = Xr("svg"), t = Xr("title"), r = l5("Muted volume"), a = Xr("g"), i = Xr("path"), l = Xr("path"), s = Xr("defs"), o = Xr("clipPath"), u = Xr("rect"), this.h();
    },
    l(c) {
      e = Wr(c, "svg", {
        width: !0,
      ...
      t = Wr(d, "title", {});
      var f = jr(t);
      r = r5(f, "Muted volume"), f.forEach(kr), a = Wr(d, "g", { "clip-path": !0 });
      var p = jr(a);
      i = Wr(p, "path", {
        d: !0,
        "stroke-width": !0,
    ...
    m(c, d) {
      a5(c, e, d), Gr(e, t), Gr(t, r), Gr(e, a), Gr(a, i), Gr(a, l), Gr(e, s), Gr(s, o), Gr(o, u);
    },
    p: Ps,
    i: Ps,
    o: Ps,
...
var Au = 0, Fl = 1, sa = 2, Cr = 3, $a = 4, F0 = 5, ha = 6, Qt = 7, ar = [new Yr(Au, 0, !1), new Yr(Fl, 0, !0), new Yr(sa, 1, !1), new Yr(Cr, 1, !0), new Yr($a, 2, !1), new Yr(F0, 2, !0), new Yr(ha, 3, !1), new Yr(Qt, 3, !0)], A5 = [$a, F0, $a, F0, ha, Qt, ha, Qt], E5 = [F0, F0, F0, F0, Qt, Qt, Qt, Qt], S5 = [sa, Cr, $a, F0, ha, Qt, ha, Qt], x5 = [Cr, Cr, F0, F0, Qt, Qt, Qt, Qt], T5 = [Fl, Fl, Cr, Cr, F0, F0, Qt, Qt], F5 = [Au, Fl, sa, Cr, sa, Cr, sa, Cr], se = {
  DISPLAY: ar[Au],
  TEXT: ar[sa],
  SCRIPT: ar[$a],
  SCRIPTSCRIPT: ar[ha]
...
class Sr {
   ...
   */
  constructor(e) {
    this.style = void 0, this.color = void 0, this.size = void 0, this.textSize = void 0, this.phantom = void 0, this.font = void 0, this.fontFamily = void 0, this.fontWeight = void 0, this.fontShape = void 0, this.sizeMultiplier = void 0, this.maxSize = void 0, this.minRuleThickness = void 0, this._fontMetrics = void 0, this.style = e.style, this.color = e.color, this.size = e.size || Sr.BASESIZE, this.textSize = e.textSize || this.size, this.phantom = !!e.phantom, this.font = e.font || "", this.fontFamily = e.fontFamily || "", this.fontWeight = e.fontWeight || "", this.fontShape = e.fontShape || "", this.sizeMultiplier = G1[this.size - 1], this.maxSize = e.maxSize, this.minRuleThickness = e.minRuleThickness, this._fontMetrics = void 0;
  }
  /**
...
var m = "math", H = "text", _ = "main", S = "ams", Ke = "accent-token", Q = "bin", t0 = "close", da = "inner", le = "mathord", vt = "op-token", v0 = "open", Ql = "punct", x = "rel", Ur = "spacing", M = "textord";
h(m, _, x, "≡", "\\equiv", !0);
h(m, _, x, "≺", "\\prec", !0);
h(m, _, x, "≻", "\\succ", !0);
h(m, _, x, "∼", "\\sim", !0);
...
for (var kn = 0; kn < 10; kn++) {
  var Zr = kn.toString();
  fe = String.fromCharCode(55349, 57294 + kn), h(m, _, le, Zr, fe), h(H, _, M, Zr, fe), fe = String.fromCharCode(55349, 57314 + kn), h(m, _, le, Zr, fe), h(H, _, M, Zr, fe), fe = String.fromCharCode(55349, 57324 + kn), h(m, _, le, Zr, fe), h(H, _, M, Zr, fe), fe = String.fromCharCode(55349, 57334 + kn), h(m, _, le, Zr, fe), h(H, _, M, Zr, fe);
}
var Xo = "ÐÞþ";
...
var Ui = [
  ...
  var [r, a, i] = Td[e], l = new fn(r), s = new Lr([l], {
    width: Z(a),
    height: Z(i),
...
}, Nr = N.makeSpan, f3 = ["leftmost", "mbin", "mopen", "mrel", "mop", "mpunct"], h3 = ["rightmost", "mrel", "mclose", "mpunct"], d3 = {
  display: se.DISPLAY,
  text: se.TEXT,
  script: se.SCRIPT,
...
var Mu = (n, e) => {
  ...
  var t = n.isStretchy ? Rr.mathMLnode(n.label) : new j.MathNode("mo", [L0(n.label, n.mode)]), r = new j.MathNode("mover", [Pe(n.base, e), t]);
...
J({
  ...
  mathmlBuilder: (n, e) => {
    var t = Rr.mathMLnode(n.label), r = new j.MathNode("munder", [Pe(n.base, e), t]);
...
var Ha = function(e, t, r) {
  ...
  var a = lr["Size4-Regular"][e.charCodeAt(0)] ? lr["Size4-Regular"][e.charCodeAt(0)][4] : lr["Size1-Regular"][e.charCodeAt(0)][4], i = new fn("inner", q5(e, Math.round(1e3 * t))), l = new Lr([i], {
    width: Z(a),
    height: Z(t),
    // Override CSS rule `.katex svg { width: 100% }`
    style: "width:" + Z(a),
  ...
  var I = B / 2 - L, P = [];
  if (d.length > 0) {
    var $ = B - b - y, O = Math.round(B * 1e3), K = P5(d, Math.round($ * 1e3)), q = new fn(d, K), he = (f / 1e3).toFixed(3) + "em", ee = (O / 1e3).toFixed(3) + "em", _e = new Lr([q], {
      width: he,
      height: ee,
      viewBox: "0 0 " + f + " " + O
  ...
  var l = O5(e, a, r), s = new fn(e, l), o = new Lr([s], {
...
J({
  ...
  htmlBuilder: (n, e) => {
    ...
    var s;
    if (n.left === "." ? s = ei(e, ["mopen"]) : s = Mr.leftRightDelim(n.left, r, a, e, n.mode, ["mopen"]), t.unshift(s), i)
...
var Bu = (n, e) => {
  ...
  if (r === "sout")
    ...
    var f = Math.floor(1e3 * d * a), p = N5(f), g = new Lr([new fn("phase", p)], {
      width: "400em",
      height: Z(f / 1e3),
...
_r({
  ...
  handler(n, e) {
    ...
    return pn(n.parser, i, Nu(n.envName));
  },
  htmlBuilder: vr,
  mathmlBuilder: br
});
_r({
  ...
  handler(n) {
    ...
    var i = pn(n.parser, r, Nu(n.envName)), l = Math.max(0, ...i.body.map((s) => s.length));
...
var e4 = (n, e) => {
  ...
  var E, T;
  return n.leftDelim == null ? E = ei(e, ["mopen"]) : E = Mr.customSizedDelim(n.leftDelim, D, !0, e.havingStyle(t), n.mode, ["mopen"]), n.continued ? T = N.makeSpan([]) : n.rightDelim == null ? T = ei(e, ["mclose"]) : T = Mr.customSizedDelim(n.rightDelim, D, !0, e.havingStyle(t), n.mode, ["mclose"]), N.makeSpan(["mord"].concat(i.sizingClasses(e)), [E, N.makeSpan(["mfrac"], [A]), T], e);
}, Ou = (n, e) => {
...
Rn({
  type: "tag",
  mathmlBuilder(n, e) {
    var t = new j.MathNode("mtable", [new j.MathNode("mtr", [hc(), new j.MathNode("mtd", [hn(n.body, e)]), hc(), new j.MathNode("mtd", [hn(n.tag, e)])])]);
...
var gc = (n) => n.body.replace(/ /g, n.star ? "␣" : " "), ln = Fd, s4 = `[ \r
...
v("\\show", (n) => {
  ...
  return console.log(e, n.macros.get(t), ln[t], Ue.math[t], Ue.text[t]), "";
});
v("\\bgroup", "{");
v("\\egroup", "}");
v("~", "\\nobreakspace");
...
class l6 {
   ...
   */
  isDefined(e) {
    return this.macros.has(e) || ln.hasOwnProperty(e) || Ue.math.hasOwnProperty(e) || Ue.text.hasOwnProperty(e) || c4.hasOwnProperty(e);
  }
  /**
...
class sr {
  constructor(e) {
    ...
    Ge(this, "tokenizer");
    Ge(this, "inlineQueue");
    this.tokens = [], this.tokens.links = /* @__PURE__ */ Object.create(null), this.options = e || On, this.options.tokenizer = this.options.tokenizer || new Il(), this.tokenizer = this.options.tokenizer, this.tokenizer.options = this.options, this.tokenizer.lexer = this, this.inlineQueue = [], this.state = {
      inLink: !1,
      inRawBlock: !1,
      top: !0
    };
...
class or {
  constructor(e) {
    ...
    this.options = e || On, this.options.renderer = this.options.renderer || new Nl(), this.renderer = this.options.renderer, this.renderer.options = this.options, this.textRenderer = new Zu();
  }
  /**
   * Static Parse Method
   */
...
class D4 {
  constructor(...e) {
    ...
    Ge(this, "parse", Ei(this, Nn, tu).call(this, sr.lex, or.parse));
    Ge(this, "parseInline", Ei(this, Nn, tu).call(this, sr.lexInline, or.parseInline));
    Ge(this, "Parser", or);
    Ge(this, "Renderer", Nl);
...
Nn = new WeakSet(), tu = function(e, t) {
  return (r, a) => {
    ...
    const s = Ei(this, Nn, A4).call(this, !!l.silent, !!l.async);
...
Re.options = Re.setOptions = function(n) {
  return In.setOptions(n), Re.defaults = In.defaults, d4(Re.defaults), Re;
};
Re.getDefaults = Vu;
Re.defaults = On;
Re.use = function(...n) {
  return In.use(...n), Re.defaults = In.defaults, d4(Re.defaults), Re;
};
Re.walkTokens = function(n, e) {
  return In.walkTokens(n, e);
};
Re.parseInline = In.parseInline;
Re.Parser = or;
Re.parser = or.parse;
Re.Renderer = Nl;
Re.TextRenderer = Zu;
...
class L4 {
  /* CONSTRUCTOR */
  constructor(e = {}) {
    $r.set(this, void 0), wl.set(this, void 0), yl.set(this, void 0), this.getConfiguration = () => ru(An(this, $r, "f")), this.sanitize = (c) => {
      const d = An(this, wl, "f"), f = An(this, yl, "f");
      return p7(c, (p, g) => {
    ...
    o && (An(this, $r, "f").allowElements = e.allowElements), u && (An(this, $r, "f").allowAttributes = e.allowAttributes), lo(this, wl, new Set(An(this, $r, "f").allowElements), "f"), lo(this, yl, Object.fromEntries(Object.entries(An(this, $r, "f").allowAttributes || {}).map(([c, d]) => [c, new Set(d)])), "f");
  }
}
$r = /* @__PURE__ */ new WeakMap(), wl = /* @__PURE__ */ new WeakMap(), yl = /* @__PURE__ */ new WeakMap();
...
function z7(n, e = kl) {
  ...
  function a(l) {
    if (o = l, ((s = n) != s ? o == o : s !== o || s && typeof s == "object" || typeof s == "function") && (n = l, t)) {
      const u = !Yn.length;
      for (const c of r) c[1](), Yn.push(c, n);
      if (u) {
...
function J7(n) {
  ...
  return {
    ...
    m(d, f) {
      me(d, e, f), X4(t, e, null), me(d, r, f), me(d, a, f), xn(a, l), me(d, s, f), c && c.m(d, f), o = !0;
    },
    p(d, f) {
      const p = {};
      f[0] & /*i18n*/
...
function Sn(n) {
  ...
  for (const [t, r] of K4(n))
    j0(n, t) && (Array.isArray(r) ? e[t] = yp(r) : r && typeof r == "object" && r.constructor === Object ? e[t] = Sn(r) : e[t] = r);
  return e;
}
function Ba(n, e) {
  for (; n !== null; ) {
...
function em() {
  ...
  })), pe = null, Se = null, Be = !0, G = !0, ge = !1, Ee = !0, Ie = !1, ot = !0, qe = !1, Ve = !1, xt = !1, Tt = !1, bt = !1, Je = !1, b0 = !0, Vr = !1;
  ...
  let wt = null;
  const wr = ke({}, ["alt", "class", "for", "id", "label", "name", "pattern", "placeholder", "role", "summary", "title", "value", "style", "xmlns"]), Lt = "http://www.w3.org/1998/Math/MathML", d0 = "http://www.w3.org/2000/svg", yt = "http://www.w3.org/1999/xhtml";
  let w0 = yt, yn = !1, q0 = null;
  ...
  const Sm = t.createElement("form"), c1 = function(z) {
    ...
    if (!(Vn && Vn === z)) {
      if ((!z || typeof z != "object") && (z = {}), z = Sn(z), _a = // eslint-disable-next-line unicorn/prefer-includes
      Am.indexOf(z.PARSER_MEDIA_TYPE) === -1 ? Em : z.PARSER_MEDIA_TYPE, Ft = _a === "application/xhtml+xml" ? oo : Dl, re = j0(z, "ALLOWED_TAGS") ? ke({}, z.ALLOWED_TAGS, Ft) : oe, ve = j0(z, "ALLOWED_ATTR") ? ke({}, z.ALLOWED_ATTR, Ft) : ze, q0 = j0(z, "ALLOWED_NAMESPACES") ? ke({}, z.ALLOWED_NAMESPACES, oo) : ga, wt = j0(z, "ADD_URI_SAFE_ATTR") ? ke(Sn(wr), z.ADD_URI_SAFE_ATTR, Ft) : wr, je = j0(z, "ADD_DATA_URI_TAGS") ? ke(Sn(be), z.ADD_DATA_URI_TAGS, Ft) : be, Qe = j0(z, "FORBID_CONTENTS") ? ke({}, z.FORBID_CONTENTS, Ft) : V, pe = j0(z, "FORBID_TAGS") ? ke({}, z.FORBID_TAGS, Ft) : {}, Se = j0(z, "FORBID_ATTR") ? ke({}, z.FORBID_ATTR, Ft) : {}, Ce = j0(z, "USE_PROFILES") ? z.USE_PROFILES : !1, Be = z.ALLOW_ARIA_ATTR !== !1, G = z.ALLOW_DATA_ATTR !== !1, ge = z.ALLOW_UNKNOWN_PROTOCOLS || !1, Ee = z.ALLOW_SELF_CLOSE_IN_ATTR !== !1, Ie = z.SAFE_FOR_TEMPLATES || !1, ot = z.SAFE_FOR_XML !== !1, qe = z.WHOLE_DOCUMENT || !1, Tt = z.RETURN_DOM || !1, bt = z.RETURN_DOM_FRAGMENT || !1, Je = z.RETURN_TRUSTED_TYPE || !1, xt = z.FORCE_BODY || !1, b0 = z.SANITIZE_DOM !== !1, Vr = z.SANITIZE_NAMED_PROPS || !1, R = z.KEEP_CONTENT !== !1, U = z.IN_PLACE || !1, de = z.ALLOWED_URI_REGEXP || Q4, w0 = z.NAMESPACE || yt, ki = z.MATHML_TEXT_INTEGRATION_POINTS || ki, Di = z.HTML_INTEGRATION_POINTS || Di, W = z.CUSTOM_ELEMENT_HANDLING || {}, z.CUSTOM_ELEMENT_HANDLING && c1(z.CUSTOM_ELEMENT_HANDLING.tagNameCheck) && (W.tagNameCheck = z.CUSTOM_ELEMENT_HANDLING.tagNameCheck), z.CUSTOM_ELEMENT_HANDLING && c1(z.CUSTOM_ELEMENT_HANDLING.attributeNameCheck) && (W.attributeNameCheck = z.CUSTOM_ELEMENT_HANDLING.attributeNameCheck), z.CUSTOM_ELEMENT_HANDLING && typeof z.CUSTOM_ELEMENT_HANDLING.allowCustomizedBuiltInElements == "boolean" && (W.allowCustomizedBuiltInElements = z.CUSTOM_ELEMENT_HANDLING.allowCustomizedBuiltInElements), Ie && (G = !1), bt && (Tt = !0), Ce && (re = ke({}, lf), ve = [], Ce.html === !0 && (ke(re, af), ke(ve, sf)), Ce.svg === !0 && (ke(re, uo), ke(ve, ho), ke(ve, el)), Ce.svgFilters === !0 && (ke(re, co), ke(ve, ho), ke(ve, el)), Ce.mathMl === !0 && (ke(re, fo), ke(ve, of), ke(ve, el))), z.ADD_TAGS && (re === oe && (re = Sn(re)), ke(re, z.ADD_TAGS, Ft)), z.ADD_ATTR && (ve === ze && (ve = Sn(ve)), ke(ve, z.ADD_ATTR, Ft)), z.ADD_URI_SAFE_ATTR && ke(wt, z.ADD_URI_SAFE_ATTR, Ft), z.FORBID_CONTENTS && (Qe === V && (Qe = Sn(Qe)), ke(Qe, z.FORBID_CONTENTS, Ft)), R && (re["#text"] = !0), qe && ke(re, ["html", "head", "body"]), re.table && (ke(re, ["tbody"]), delete pe.tbody), z.TRUSTED_TYPES_POLICY) {
    ...
    if (!Y || !Y.documentElement) {
      ...
      try {
        Y.documentElement.innerHTML = yn ? E : We;
      } catch {
      }
    }
  ...
  const g1 = function(z) {
    let Y = null;
    if (yr(I.beforeSanitizeElements, z, null), ws(z))
      return Q0(z), !0;
    ...
    for (; We--; ) {
      ...
      if (te.attrName = va, te.attrValue = Zt, te.keepAttr = !0, te.forceKeepAttr = void 0, yr(I.uponSanitizeAttribute, z, te), Zt = te.attrValue, Vr && (va === "id" || va === "name") && (Ai(Nt, z), Zt = wn + Zt), ot && Jt(/((--!?|])>)|<\/(style|title)/i, Zt)) {
        Ai(Nt, z);
        continue;
      }
    ...
    for (yr(I.beforeSanitizeShadowDOM, z, null); Y = te.nextNode(); )
      yr(I.uponSanitizeShadowNode, Y, null), g1(Y), b1(Y), Y.content instanceof i && ne(Y.content);
  ...
  return e.sanitize = function(ne) {
    ...
    if (yn = !ne, yn && (ne = "<!-->"), typeof ne != "string" && !p1(ne))
...
function I8(n) {
  ...
  return {
    ...
    h() {
      go(t, "class", "icon svelte-3w3rth"), go(e, "class", "empty svelte-3w3rth"), go(e, "aria-label", "Empty value"), Jr(
        e,
        "small",
        /*size*/
        n[0] === "small"
...
function j8(n) {
  ...
  return {
    c() {
      t = Fn(e), r = us(), i && i.c(), a = Ol();
    },
    l(l) {
      t = Tn(l, e), r = os(l), i && i.l(l), a = Ol();
    },
    m(l, s) {
...
function Ff(n) {
  ...
  return {
    c() {
      e = ai("span"), t = Fn("- "), a = Fn(r), i = Fn(" -"), l = us(), o = Fn(s), this.h();
    },
    l(u) {
      e = ni(u, "SPAN", { class: !0 });
      var c = ri(e);
      t = Tn(c, "- "), a = Tn(c, r), i = Tn(c, " -"), c.forEach(Yt), l = os(u), o = Tn(u, s), this.h();
    },
    h() {
...
function Zf(n) {
  ...
  return {
    ...
    l(t) {
      e = Mn(t, "DIV", { class: !0 }), ua(e).forEach(z0), this.h();
    },
    h() {
...
function xg(n) {
  ...
  return {
    ...
    h() {
      jf(e.src, t = /*icon*/
      n[0]) || on(e, "src", t), on(e, "alt", "Audio visualization icon"), on(e, "class", "icon-image svelte-18h18u4"), Wf(
        e,
        "full-screen",
        /*full_screen*/
        n[4] || /*full_screen*/
...
function Tg(n) {
  ...
  return i = d(n), l = c[i] = u[i](n), {
    c() {
      e = zn("div"), t = zn("div"), o && o.c(), r = Dg(), a = zn("div"), l.c(), this.h();
    },
    l(f) {
      e = Mn(f, "DIV", { class: !0 });
      var p = ua(e);
      t = Mn(p, "DIV", { class: !0 });
      var g = ua(t);
      o && o.l(g), r = bg(g), a = Mn(g, "DIV", { class: !0 });
      var b = ua(a);
...
function Qf(n) {
  ...
  return t = new fi({
    ...
    c() {
      e = jt("div"), _n(t.$$.fragment), this.h();
    },
    l(a) {
      e = Gt(a, "DIV", { class: !0 });
      var i = Vt(e);
      gn(t.$$.fragment, i), i.forEach(Me), this.h();
    },
    h() {
      at(e, "class", "audio-indicator svelte-1a31haa");
    },
    m(a, i) {
      l0(a, e, i), bn(t, e, null), r = !0;
    },
    p(a, i) {
      const l = {};
      i[0] & /*stream_state*/
...
function Vg(n) {
  ...
  return {
    c() {
      e = jt("div"), t = jt("button"), a.c(), i = mr(), g && g.c(), l = mr(), b && b.c(), s = Gl(), this.h();
    },
    l(A) {
      e = Gt(A, "DIV", { class: !0 });
      var w = Vt(e);
      ...
      var k = Vt(t);
      a.l(k), k.forEach(Me), i = dr(w), g && g.l(w), w.forEach(Me), l = dr(A), b && b.l(A), s = Gl(), this.h();
    },
    h() {
      at(t, "aria-label", "start stream"), at(t, "class", "svelte-1a31haa"), at(e, "class", "button-wrap svelte-1a31haa");
    },
    m(A, w) {
...
function Gg(n) {
  ...
  return t = new um({}), t.$on(
    ...
    l(i) {
      ...
      var l = Vt(e);
      gn(t.$$.fragment, l), l.forEach(Me), this.h();
    },
    h() {
      at(e, "title", "grant webcam access"), qg(e, "height", "100%");
    },
    m(i, l) {
      l0(i, e, l), bn(t, e, null), a = !0;
    },
    p: mm,
    i(i) {
...
function jg(n) {
  ...
  return r = new Jl({}), {
    c() {
      e = jt("div"), t = jt("div"), _n(r.$$.fragment), a = mr(), l = mi(i), this.h();
    },
    l(o) {
      e = Gt(o, "DIV", { class: !0 });
      var u = Vt(e);
      ...
      var c = Vt(t);
      gn(r.$$.fragment, c), c.forEach(Me), a = dr(u), l = hi(u, i), u.forEach(Me), this.h();
    },
    h() {
      at(t, "class", "icon color-primary svelte-1a31haa"), at(t, "title", "start recording"), at(e, "class", "icon-with-text svelte-1a31haa");
    },
    m(o, u) {
      l0(o, e, u), mt(e, t), bn(r, t, null), mt(e, a), mt(e, l), s = !0;
    },
    p(o, u) {
...
function Wg(n) {
  ...
  return r = new _d({}), {
    ...
    h() {
      at(t, "class", "icon color-primary svelte-1a31haa"), at(t, "title", "stop recording"), at(e, "class", "icon-with-text svelte-1a31haa");
    },
    m(o, u) {
      l0(o, e, u), mt(e, t), bn(r, t, null), mt(e, a), mt(e, l), s = !0;
    },
...
function Xg(n) {
  ...
  return r = new ku({}), {
    ...
    h() {
      at(t, "class", "icon color-primary svelte-1a31haa"), at(t, "title", "spinner"), at(e, "class", "icon-with-text svelte-1a31haa");
    },
    m(o, u) {
      l0(o, e, u), mt(e, t), bn(r, t, null), mt(e, a), mt(e, l), s = !0;
    },
...
function Yg(n) {
  ...
  return t = new wu({}), {
    c() {
      e = jt("button"), _n(t.$$.fragment), this.h();
    },
    l(l) {
      e = Gt(l, "BUTTON", { class: !0, "aria-label": !0 });
      var s = Vt(e);
      gn(t.$$.fragment, s), s.forEach(Me), this.h();
    },
    h() {
      at(e, "class", "icon svelte-1a31haa"), at(e, "aria-label", "select input source");
    },
    m(l, s) {
      l0(l, e, s), bn(t, e, null), r = !0, a || (i = Wl(
        e,
        "click",
        /*click_handler_1*/
        n[35]
...
function $f(n) {
  ...
  return {
    c() {
      e = jt("select"), t = jt("button"), _n(r.$$.fragment), a = mr(), c.c(), this.h();
    },
    l(d) {
      ...
      var p = Vt(t);
      gn(r.$$.fragment, p), a = dr(p), p.forEach(Me), c.l(f), f.forEach(Me), this.h();
    },
    h() {
      at(t, "class", "inset-icon svelte-1a31haa"), at(e, "class", "select-wrap svelte-1a31haa"), at(e, "aria-label", "select source");
    },
    m(d, f) {
      l0(d, e, f), mt(e, t), bn(r, t, null), mt(t, a), c.m(e, null), i = !0, l || (s = [
        Wl(t, "click", Pg(
          /*click_handler_2*/
          n[36]
        )),
...
function Kg(n) {
  ...
  return {
    ...
    h() {
      e.__value = "", mu(e, e.__value), at(e, "class", "svelte-1a31haa");
    },
    m(a, i) {
      l0(a, e, i), mt(e, r);
    },
...
function eh(n) {
  ...
  return {
    c() {
      e = jt("option"), r = mi(t), a = mr(), this.h();
    },
    l(s) {
      e = Gt(s, "OPTION", { class: !0 });
      var o = Vt(e);
      r = hi(o, t), a = dr(o), o.forEach(Me), this.h();
    },
    h() {
      e.__value = i = /*device*/
      n[45].deviceId, mu(e, e.__value), e.selected = l = /*selected_device*/
      n[11].deviceId === /*device*/
      n[45].deviceId, at(e, "class", "svelte-1a31haa");
    },
    m(s, o) {
...
function Jg(n) {
  ...
  return s = p(n), o = f[s] = d[s](n), {
    c() {
      e = jt("div"), _n(t.$$.fragment), r = mr(), c && c.c(), a = mr(), i = jt("video"), l = mr(), o.c(), this.h();
    },
    l(g) {
      e = Gt(g, "DIV", { class: !0 });
      var b = Vt(e);
      gn(t.$$.fragment, b), r = dr(b), c && c.l(b), a = dr(b), i = Gt(b, "VIDEO", { class: !0 }), Vt(i).forEach(Me), l = dr(b), o.l(b), b.forEach(Me), this.h();
    },
    h() {
      i.autoplay = !0, i.playsInline = !0, at(i, "class", "svelte-1a31haa"), Zn(i, "hide", !/*webcam_accessed*/
      n[14]), Zn(
        i,
        "flip",
        /*stream_state*/
        ...
        n[13] === "open" && /*include_audio*/
        n[6]
      ), at(e, "class", "wrap svelte-1a31haa"), Zn(
        e,
        "full-screen",
        /*full_screen*/
        n[5] || /*full_screen*/
    ...
    m(g, b) {
      l0(g, e, b), bn(t, e, null), mt(e, r), c && c.m(e, null), mt(e, a), mt(e, i), n[33](i), mt(e, l), f[s].m(e, null), u = !0;
    },
    p(g, b) {
      const A = {};
      b[0] & /*_time_limit*/
      ...
      16384) && Zn(i, "hide", !/*webcam_accessed*/
    ...
    d(g) {
      g && Me(e), vn(t), c && c.d(), n[33](null), f[s].d();
    }
  };
}
function Ju(n, e) {
...
function o_(n) {
  ...
  return {
    ...
    l(f) {
      fs(e.$$.fragment, f), t = Fo(f), r = vm(f, "AUDIO", { class: !0 }), _m(r).forEach(en), a = Fo(f), c && c.l(f), i = Fo(f), d && d.l(f), l = xh(), this.h();
    },
    h() {
    ...
    p(f, [p]) {
      ...
      1 && nr(c, 1)) : (c = Fh(f), c.c(), nr(c, 1), c.m(i.parentNode, i)) : c && (Th(), tn(c, 1, 1, () => {
        c = null;
      }), Sh()), /*value*/
      f[0] === "__webrtc_value__" ? d ? p & /*value*/
      1 && nr(d, 1) : (d = Ch(f), d.c(), nr(d, 1), d.m(l.parentNode, l)) : d && (Th(), tn(d, 1, 1, () => {
        d = null;
      }), Sh());
    },
    i(f) {
    ...
    d(f) {
      f && (en(t), en(r), en(a), en(i), en(l)), ds(e, f), n[15](null), c && c.d(f), d && d.d(f), o = !1, n_(u);
    }
  };
}
function u_(n, e, t) {
...
function p_(n) {
  ...
  return {
    ...
    l(s) {
      ...
      var o = Qn(e);
      t = $n(o, "path", { d: !0 }), Qn(t).forEach(En), r = $n(o, "path", { d: !0 }), Qn(r).forEach(En), a = $n(o, "line", { x1: !0, y1: !0, x2: !0, y2: !0 }), Qn(a).forEach(En), i = $n(o, "line", { x1: !0, y1: !0, x2: !0, y2: !0 }), Qn(i).forEach(En), l = $n(o, "line", { x1: !0, y1: !0, x2: !0, y2: !0 }), Qn(l).forEach(En), o.forEach(En), this.h();
    },
    h() {
  ...
  function y(E) {
    return r(this, void 0, void 0, function* () {
      if (s.length > 0 && E && s.some((F) => E.includes(F.left) && E.includes(F.right)) && g6(g, {
        ...
        if (T.length > 0) {
          yield H_();
          const { default: F } = yield import("./mermaid.core-Dm5Kgj9C.js").then((C) => C.by);
          F.initialize({
            startOnLoad: !1,
...
function db(n) {
  ...
  return t = new Hv({}), {
    c() {
      e = gr("button"), gi(t.$$.fragment), this.h();
    },
    l(l) {
      e = pr(l, "BUTTON", {
        class: !0,
...
function Jh(n) {
  ...
  return t = u(n), r = o[t] = s[t](n), {
    c() {
      e = gr("button"), r.c(), this.h();
    },
    l(c) {
      e = pr(c, "BUTTON", { class: !0 });
      var d = Ln(e);
...
function Eb(n) {
  ...
  return {
    c() {
      e = gr("label"), u && u.c(), t = dl(), gi(r.$$.fragment), a = dl(), i = gr("div"), f.c(), l = dl(), p && p.c(), s = dl(), g && g.c(), this.h();
    },
    l(b) {
      e = pr(b, "LABEL", { class: !0 });
      var A = Ln(e);
      u && u.l(A), t = hl(A), pi(r.$$.fragment, A), a = hl(A), i = pr(A, "DIV", { class: !0 });
      var w = Ln(i);
...
function Sb(n, e, t) {
  var r = this && this.__awaiter || function(U, Ce, Qe, V) {
    ...
    return new (Qe || (Qe = Promise))(function(be, wt) {
      ...
      function d0(yt) {
        yt.done ? be(yt.value) : je(yt.value).then(wr, Lt);
      }
  ...
  function pe(U) {
    return r(this, void 0, void 0, function* () {
      ...
      let wt = O === void 0 ? !1 : V + je + be * O, wr = V + je + l * be;
      Ce.style.height = "1px";
      let Lt;
      wt && Ce.scrollHeight > wt ? Lt = wt : Ce.scrollHeight < wr ? Lt = wr : Lt = Ce.scrollHeight, Ce.style.height = `${Lt}px`;
    });
  }
  function Se(U, Ce) {
...
function Rb(n) {
  ...
  return e = new fi({
    ...
    p(r, a) {
      ...
      r[12] ? _u : Bn), a & /*icon_button_color*/
...
function ed(n) {
  ...
  return r = f(n), a = d[r] = c[r](n), {
    ...
    m(p, g) {
      s1(p, e, g), Er(e, t), d[r].m(t, null), s = !0, o || (u = vu(e, "click", function() {
        Bb(
          /*toggleMute*/
          n[4]
...
function Hb(n) {
  ...
  return b = new _d({ props: { fill: "none" } }), {
    c() {
      e = an("div"), qr(t.$$.fragment), a = pl(), T && T.c(), i = pl(), l = an("button"), s = an("div"), u.c(), d = pl(), L && L.c(), f = pl(), p = an("button"), g = an("div"), qr(b.$$.fragment), this.h();
    },
    l(I) {
      e = nn(I, "DIV", { class: !0 });
      var P = rn(e);
      Or(t.$$.fragment, P), a = ml(P), T && T.l(P), i = ml(P), l = nn(P, "BUTTON", { class: !0 });
      var $ = rn(l);
      s = nn($, "DIV", { class: !0, style: !0 });
      var O = rn(s);
      u.l(O), O.forEach(X0), $.forEach(X0), d = ml(P), L && L.l(P), f = ml(P), p = nn(P, "BUTTON", { class: !0, "aria-label": !0 });
      var K = rn(p);
    ...
    m(I, P) {
      s1(I, e, P), Hr(t, e, null), Er(e, a), T && T.m(e, null), Er(e, i), Er(e, l), Er(l, s), C[o].m(s, null), Er(e, d), L && L.m(e, null), Er(e, f), Er(e, p), Er(p, g), Hr(b, g, null), w = !0, k || (y = [
        vu(
          l,
          "click",
          /*click_mic_icon*/
    ...
    d(I) {
      I && X0(e), Pr(t), T && T.d(), C[o].d(), L && L.d(), Pr(b), k = !1, Ib(y);
    }
  };
}
function Ub(n) {
...
function ew(n) {
  ...
  return {
    ...
    h() {
      De(l, "aria-label", "start stream"), De(l, "class", "svelte-16la6ep"), De(i, "class", "button-wrap svelte-16la6ep"), Fr(
        i,
        "pulse",
        /*stopword_recognized*/
        n[13]
...
function tw(n) {
  let e, t, r, a;
  return t = new um({ props: { icon: Bn } }), t.$on(
    "click",
    /*click_handler*/
    n[52]
  ), {
...
function aw(n) {
  ...
  return t = c(n), r = u[t] = o[t](n), {
    ...
    p(d, f) {
      let p = t;
      t = c(d), t === p ? u[t].p(d, f) : (Tr(), Fe(u[p], 1, 1, () => {
        u[p] = null;
...
function ud(n) {
  ...
  return {
    ...
    h() {
      De(e, "class", "select-wrap svelte-16la6ep"), De(e, "aria-label", "select source"), Fr(
        e,
        "full-screen",
        /*full_screen*/
        n[12] || /*full_screen*/
...
function mw(n) {
  ...
  return i = p(n), l = f[i] = d[i](n), {
    ...
    h() {
      De(r, "class", "standard-player svelte-16la6ep"), Fr(r, "hidden", !0), De(t, "class", "audio-container svelte-16la6ep"), Fr(
        t,
        "full-screen",
        /*full_screen*/
        n[12] || /*full_screen*/
    ...
    p(g, b) {
      ...
      2048 && Ae(c, 1)) : (c = id(g), c.c(), Ae(c, 1), c.m(e.parentNode, e)) : c && (Tr(), Fe(c, 1, 1, () => {
        c = null;
      }), xr());
      let A = i;
      i = p(g), i === A ? f[i].p(g, b) : (Tr(), Fe(f[A], 1, 1, () => {
        f[A] = null;
...
function gw(n, e, t) {
  var r = this && this.__awaiter || function(V, je, be, wt) {
    ...
    return new (be || (be = Promise))(function(Lt, d0) {
      ...
      function yn(q0) {
        q0.done ? Lt(q0.value) : wr(q0.value).then(yt, w0);
      }
      yn((wt = wt.apply(V, je || [])).next());
    });
  };
...
function Bw(n) {
  ...
  return ~(r = d(n)) && (a = c[r] = u[r](n)), {
    c() {
      Pn(e.$$.fragment), t = xw(), a && a.c(), i = hd();
    },
    l(f) {
      qn(e.$$.fragment, f), t = yw(f), a && a.l(f), i = hd();
    },
    m(f, p) {
      Un(e, f, p), dd(f, t, p), ~r && c[r].m(f, p), dd(f, i, p), l = !0;
    },
    p(f, p) {
      ...
      e.$set(g);
      let b = r;
      r = d(f), r === b ? ~r && c[r].p(f, p) : (a && (Aw(), Ir(c[b], 1, 1, () => {
        c[b] = null;
      }), ww()), ~r ? (a = c[r], a ? a.p(f, p) : (a = c[r] = u[r](f), a.c()), Br(a, 1), a.m(i.parentNode, i)) : a = null);
    },
    i(f) {
...
function Lw(n, e, t) {
  ...
  const bt = () => w.dispatch("start_recording"), Je = () => w.dispatch("stop_recording"), b0 = () => w.dispatch("tick"), Vr = ({ detail: R }) => w.dispatch("error", R), wn = ({ detail: R }) => w.dispatch("warning", R);
  return n.$$set = (R) => {
