import { C as qe, _ as nt, aG as Je, aH as Qe, n as Ke, o as je, s as _e, g as tr, c as er, b as rr, d as fe, l as be, j as ir, t as ar, H as nr, V as or, aj as Ne, aI as Ee } from "./mermaid.core-ClIgmj79.js";
import { p as sr } from "./chunk-4BMEZGHF-Di-ue38b.js";
import { I as hr } from "./chunk-XZIHB7SX-TNP6HGCI.js";
import { p as lr } from "./radar-MK3ICKWK-CjWTsKX6.js";
import { c as Pe } from "./cytoscape.esm-C2cgT2B2.js";
import { c as Le, g as fr } from "./index-XMaphynx.js";
...
}, "isArchitectureJunction"), Ue = /* @__PURE__ */ nt((C) => C.data(), "edgeData"), ne = /* @__PURE__ */ nt((C) => C.data(), "nodeData"), Ye = qe.architecture, pt = new hr(() => ({
  nodes: {},
  groups: {},
  edges: [],
  registeredIds: {},
...
var Gr = /* @__PURE__ */ nt((C, U) => {
  sr(C, U), C.groups.map(U.addGroup), C.services.map((A) => U.addService({ ...A, type: "service" })), C.junctions.map((A) => U.addJunction({ ...A, type: "junction" })), C.edges.map(U.addEdge);
}, "populateDb"), Ur = {
  parse: /* @__PURE__ */ nt(async (C) => {
    const U = await lr("architecture", C);
    be.debug(U), Gr(U, le);
  }, "parse")
}, Yr = /* @__PURE__ */ nt((C) => `
  .edge {
